package edu.berkeley.nlp.assignments.parsing.international.arabic;
...
import edu.berkeley.nlp.assignments.parsing.international.arabic.pipeline.DefaultLexicalMapper;
 ...
 *  <li>Applies the same orthographic normalization performed by {@link edu.berkeley.nlp.assignments.parsing.trees.international.arabic.ArabicTreeNormalizer}
 *  <li>intern()'s strings
 * </ul>
 *
...
public class IBMArabicEscaper implements Function<List<HasWord>, List<HasWord>>  {
   ...
   *  prior to escaping.
   *
   *  @param sentence A collection of type {@link edu.berkeley.nlp.assignments.parsing.ling.Word}
