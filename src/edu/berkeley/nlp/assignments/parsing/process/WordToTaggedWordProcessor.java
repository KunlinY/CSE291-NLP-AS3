...
import edu.berkeley.nlp.assignments.parsing.ling.BasicDocument;
import edu.berkeley.nlp.assignments.parsing.ling.Document;
...
public class WordToTaggedWordProcessor<IN extends HasWord, L, F> extends AbstractListProcessor<IN, HasWord, L, F> {
   ...
   * java edu.berkeley.nlp.assignments.parsing.process.WordToTaggedWordProcessor fileOrUrl
   * </code>
   *
  ...
  public static void main(String[] args) {
    if (args.length != 1) {
      System.out.println("usage: java edu.berkeley.nlp.assignments.parsing.process.WordToTaggedWordProcessor fileOrUrl");
      System.exit(0);
    }
