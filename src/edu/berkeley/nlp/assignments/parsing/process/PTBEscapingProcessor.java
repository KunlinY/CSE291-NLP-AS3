...
public class PTBEscapingProcessor<IN extends HasWord, L, F> extends AbstractListProcessor<IN, HasWord, L, F>
  ...
  */
   ...
   * Usage: java edu.berkeley.nlp.assignments.parsing.process.PTBEscapingProcessor fileOrUrl
   *
   * @param args Command line argument: a file or URL
   */
  public static void main(String[] args) {
    if (args.length != 1) {
      System.out.println("usage: java edu.berkeley.nlp.assignments.parsing.process.PTBEscapingProcessor fileOrUrl");
      return;
    }
