 ...
 * tokens of classes that implement edu.berkeley.nlp.assignments.parsing.trees.HasWord
...
public class PTBTokenizer<T extends HasWord> extends AbstractTokenizer<T>  {
   ...
   * <p>
   * Usage: {@code java edu.berkeley.nlp.assignments.parsing.process.PTBTokenizer [options] filename+ }
   * <p>
   * Options:
   * <ul>
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (showHelp) {
      log.info("Usage: java edu.berkeley.nlp.assignments.parsing.process.PTBTokenizer [options]* filename*");
