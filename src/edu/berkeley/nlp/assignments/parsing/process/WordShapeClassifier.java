...
import edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.ChineseUtils;
...
public class WordShapeClassifier  {
  ...
  /**
   * Usage: <code>java edu.berkeley.nlp.assignments.parsing.process.WordShapeClassifier
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      System.out.println("edu.berkeley.nlp.assignments.parsing.process.WordShapeClassifier [-wordShape name] string+");
