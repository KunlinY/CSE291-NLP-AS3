package edu.berkeley.nlp.assignments.parsing.ie.util;

import java.text.DecimalFormat;
import java.util.*;
import java.util.function.ToIntFunction;

import edu.berkeley.nlp.assignments.parsing.ie.machinereading.structure.Span;
...
import edu.berkeley.nlp.assignments.parsing.semgraph.SemanticGraph;
import edu.berkeley.nlp.assignments.parsing.semgraph.SemanticGraphEdge;
import edu.berkeley.nlp.assignments.parsing.util.PriorityQueue;
import edu.berkeley.nlp.assignments.parsing.util.*;

import static edu.berkeley.nlp.assignments.parsing.util.logging.Redwood.Util.err;
...
public class RelationTriple implements Comparable<RelationTriple>, Iterable<CoreLabel> {
  ...
  /**
   * @see edu.berkeley.nlp.assignments.parsing.ie.util.RelationTriple#RelationTriple(java.util.List, java.util.List, java.util.List, double)
   */
  public RelationTriple(List<CoreLabel> subject, List<CoreLabel> relation, List<CoreLabel> object) {
...
//    return result;
  ...
  /**
   * A {@link edu.berkeley.nlp.assignments.parsing.ie.util.RelationTriple}, but with the tree saved as well.
   */
  ...
  /**
   * A {@link edu.berkeley.nlp.assignments.parsing.ie.util.RelationTriple}, but with both the tree and the entity
   * links saved as well.
   */
