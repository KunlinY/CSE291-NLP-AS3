...
import edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.ChineseEnglishWordMap;
 ...
 * {@code edu.berkeley.nlp.assignments.parsing.trees.Tree} as the output of the
...
//            log.info(childIndex+"\t"+parentIndex);
  ...
  private static synchronized Tree getCollocationProcessedTree(Tree tree,
    ...
    if (wnc == null) {
      try {
        Class<?> cl = Class.forName("edu.berkeley.nlp.assignments.parsing.trees.WordNetInstance");
   ...
   *  <li> -tLP class (the TreebankLanguagePack, default "edu.berkeley.nlp.assignments.parsing.tree.PennTreebankLanguagePack")
  ...
  public static void main(String[] args) {
    String format = "penn";
    String options = "";
    String tlpName = "edu.berkeley.nlp.assignments.parsing.trees.PennTreebankLanguagePack";
    String hfName = null;
