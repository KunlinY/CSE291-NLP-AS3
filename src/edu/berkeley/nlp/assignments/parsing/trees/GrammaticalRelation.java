...
import edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.ChineseGrammaticalRelations;
...
import edu.berkeley.nlp.assignments.parsing.util.ArraySet;
 ...
 * @see edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.ChineseGrammaticalRelations
 *
...
public class GrammaticalRelation implements Comparable<GrammaticalRelation>, Serializable  {
  ...
  private GrammaticalRelation(Language language,
    ...
    for (String pattern : targetPatterns) {
      ...
      } catch (edu.berkeley.nlp.assignments.parsing.trees.tregex.TregexParseException pe) {
