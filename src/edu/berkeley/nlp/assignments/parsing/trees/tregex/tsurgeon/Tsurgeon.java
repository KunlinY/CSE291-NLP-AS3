...
package edu.berkeley.nlp.assignments.parsing.trees.tregex.tsurgeon;

import edu.berkeley.nlp.assignments.parsing.io.IOUtils;
import edu.berkeley.nlp.assignments.parsing.trees.*;
import edu.berkeley.nlp.assignments.parsing.trees.tregex.Macros;
 ...
 *  <blockquote>
 * java edu.berkeley.nlp.assignments.parsing.trees.tregex.tsurgeon.Tsurgeon -treeFile aTree
 *        exciseNP renameVerb
 * </blockquote>
...
public class Tsurgeon  {
  ...
  /** Usage: java edu.berkeley.nlp.assignments.parsing.trees.tregex.tsurgeon.Tsurgeon [-s] -treeFile file-with-trees [-po matching-pattern operation] operation-file-1 operation-file-2 ... operation-file-n
   *
   * <h4>Arguments:</h4>
   *
  ...
  public static void main(String[] args) throws Exception {
    ...
    if(args.length==0) {
      log.info("Usage: java edu.berkeley.nlp.assignments.parsing.trees.tregex.tsurgeon.Tsurgeon [-s] -treeFile <file-with-trees> [-po <matching-pattern> <operation>] <operation-file-1> <operation-file-2> ... <operation-file-n>");
      System.exit(0);
    }
