...
import edu.berkeley.nlp.assignments.parsing.trees.HasParent;
import edu.berkeley.nlp.assignments.parsing.trees.HeadFinder;
import edu.berkeley.nlp.assignments.parsing.trees.Tree;

/**
 * A TregexMatcher can be used to match a {@link TregexPattern} against a {@link edu.berkeley.nlp.assignments.parsing.trees.Tree}.
