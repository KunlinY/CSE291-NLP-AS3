...
import edu.berkeley.nlp.assignments.parsing.graph.DirectedMultiGraph;
import edu.berkeley.nlp.assignments.parsing.international.Language;
import edu.berkeley.nlp.assignments.parsing.io.IOUtils;
import edu.berkeley.nlp.assignments.parsing.ling.AbstractCoreLabel;
...
import edu.berkeley.nlp.assignments.parsing.ling.IndexedWord;
import edu.berkeley.nlp.assignments.parsing.ling.Label;
import edu.berkeley.nlp.assignments.parsing.ling.Word;
import edu.berkeley.nlp.assignments.parsing.trees.ud.EnhancementOptions;
...
import static edu.berkeley.nlp.assignments.parsing.trees.GrammaticalRelation.DEPENDENT;
import static edu.berkeley.nlp.assignments.parsing.trees.GrammaticalRelation.ROOT;
...
public abstract class GrammaticalStructure implements Serializable  {
   ...
   * If you're in doubt, use {@link edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#NONE}.
   */
  public enum Extras {
    /**
    ...
    /**
     * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#SUBJ_ONLY
     * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#REF_ONLY_UNCOLLAPSED
     */
    REF_UNCOLLAPSED_AND_SUBJ(true, true, false),
    /**
     * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#SUBJ_ONLY
     * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#REF_ONLY_COLLAPSED
     */
    REF_COLLAPSED_AND_SUBJ(true, true, true),
    /**
     *   Do the maximal amount of extra processing.
     *   Currently, this is equivalent to {@link edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras#REF_COLLAPSED_AND_SUBJ}.
     *
     *   Note: In older code (2014 and before) including extras was a boolean flag. This option is the equivalent of
     *   the {@code true} flag.
     */
  ...
  /**
   * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure#typedDependencies(edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
  ...
  /**
   * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure#typedDependenciesCollapsed(edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
  ...
  /**
   * @see edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure#typedDependenciesCCprocessed(edu.berkeley.nlp.assignments.parsing.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
