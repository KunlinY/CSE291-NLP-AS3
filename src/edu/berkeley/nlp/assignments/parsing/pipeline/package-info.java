 ...
 * or
 * <pre>
 * java -cp stanford-corenlp-YYYY-MM-DD.jar:stanford-corenlp-YYYY-MM-DD-models.jar:xom.jar:joda-time.jar -Xmx3g edu.berkeley.nlp.assignments.parsing.pipeline.StanfordCoreNLP [ -props YOUR_CONFIGURATION_FILE ] -file YOUR_INPUT_FILE
 * </pre>
 ...
 * <pre>
 * java -cp classes/:lib/xom.jar -Xmx2g edu.berkeley.nlp.assignments.parsing.pipeline.StanfordCoreNLP -props pipe.properties
 * </pre>
 ...
 * <pre>
 * java -cp classes/:lib/xom.jar -Xmx6g edu.berkeley.nlp.assignments.parsing.pipeline.StanfordCoreNLP -props pipe.properties -file data -extension .txt
 * </pre>
 ...
 * <pre>
 * java -cp classes/:lib/xom.jar -Xmx6g edu.berkeley.nlp.assignments.parsing.pipeline.StanfordCoreNLP -props pipe.properties -filelist list_of_files_to_process.txt
 * </pre>
 ...
 */
package edu.berkeley.nlp.assignments.parsing.pipeline;
