...
import edu.berkeley.nlp.assignments.parsing.stats.TwoDimensionalIntCounter;
...
//        }
  ...
  private static Options getOptions(Language language) {
    ...
    if (language.equals(Language.Arabic)) {
      ...
      options.lexOptions.uwModelTrainer = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.ArabicUnknownWordModelTrainer";
    } else if (language.equals(Language.French)) {
      options.lexOptions.useUnknownWordSignatures = 1;
      options.lexOptions.unknownPrefixSize = 1;
      options.lexOptions.unknownSuffixSize = 2;
      options.lexOptions.uwModelTrainer = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.FrenchUnknownWordModelTrainer";
    } else {
