...
import edu.berkeley.nlp.assignments.parsing.process.WordSegmenter;
import edu.berkeley.nlp.assignments.parsing.process.WordSegmentingTokenizer;
import edu.berkeley.nlp.assignments.parsing.trees.*;
import edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.*;
...
public class ChineseTreebankParserParams extends AbstractTreebankParserParams  {
  ...
  public Lexicon lex(Options op, Index<String> wordIndex, Index<String> tagIndex) {
    ...
    if (op.lexOptions.uwModelTrainer == null) {
      op.lexOptions.uwModelTrainer = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.ChineseUnknownWordModelTrainer";
    }
  ...
  public int setOptionFlag(String[] args, int i) {
    ...
    if (args[i].equalsIgnoreCase("-paRootDtr")) {
      ...
      segment = true;
      segmentMarkov = true;
      segmenterClass = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.ChineseMarkovWordSegmenter";
      i++;
    } else if (args[i].equalsIgnoreCase("-segmentMaxMatch")) {
      segment = true;
      segmentMarkov = false;
      segmenterClass = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.MaxMatchSegmenter";
      i++;
    } else if (args[i].equalsIgnoreCase("-segmentDPMaxMatch")) {
      segment = true;
      segmentMarkov = false;
      segmenterClass = "edu.berkeley.nlp.assignments.parsing.wordseg.MaxMatchSegmenter";
      i++;
  ...
  public static void main(String[] args) {
    ...
    if (args.length < 2) {
      printlnErr("Usage: edu.berkeley.nlp.assignments.parsing.parser.lexparser.ChineseTreebankParserParams treesPath fileRange");
    } else {
