...
import edu.berkeley.nlp.assignments.parsing.trees.international.pennchinese.ChineseEscaper;
...
//    DocumentPreprocessor documentPreprocessor = new DocumentPreprocessor();
    ...
    int argIndex = 0;
    if (args.length < 1) {
      log.info("usage: java edu.berkeley.nlp.assignments.parsing.parser.lexparser." +
    ...
    if (saveToSerializedFile) {
      ...
      if (serializedOutputFileOrUrl != null) {
        ...
        log.info("usage: " + "java edu.berkeley.nlp.assignments.parsing.parser.lexparser.ChineseLexiconAndWordSegmenter" + "-train trainFilesPath [start stop] serializedParserFilename");
      }
    }
    /* --------------------- Testing part!!!! ----------------------- */
    if (op.testOptions.verbose) {
