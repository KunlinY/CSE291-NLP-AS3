 ...
 * <blockquote>
 * {@code java -mx100m -cp "*" edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser
 ...
 * <blockquote>{@code
 * java -mx100m -cp "*" edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser -tLPP
 * edu.berkeley.nlp.assignments.parsing.parser.lexparser.ChineseTreebankParserParams
 ...
 * tokenizer ({@code edu.berkeley.nlp.assignments.parsing.processor.PTBTokenizer}) is
 ...
 * {@code -tokenizerFactory edu.berkeley.nlp.assignments.parsing.process.WhitespaceTokenizer
 ...
 * with this command:</p>
 * <blockquote>{@code
 * java edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser -maxLength 20 -sentences newline -tokenized -tagSeparator / -tokenizerFactory edu.berkeley.nlp.assignments.parsing.process.WhitespaceTokenizer -tokenizerMethod newCoreLabelTokenizerFactory englishPCFG.ser.gz pos-sentences.txt
 * }</blockquote>
 ...
 * {@code edu.berkeley.nlp.assignments.parsing.parser.ViterbiParser}
 * and {@code edu.berkeley.nlp.assignments.parsing.process.Function}.
 ...
 * import edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser;
 * class ParserDemo {
 ...
 * import edu.berkeley.nlp.assignments.parsing.objectbank.TokenizerFactory;
 * import edu.berkeley.nlp.assignments.parsing.process.CoreLabelTokenFactory;
 ...
 * <blockquote>{@code
 * java -mx1500m edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser
 ...
 * <blockquote>{@code
 * java -mx500m edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser
