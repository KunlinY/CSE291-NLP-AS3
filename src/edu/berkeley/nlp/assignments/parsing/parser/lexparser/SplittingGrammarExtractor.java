...
import edu.berkeley.nlp.assignments.parsing.util.ThreeDimensionalMap;
import edu.berkeley.nlp.assignments.parsing.util.Triple;
import edu.berkeley.nlp.assignments.parsing.util.TwoDimensionalMap;
...
public class SplittingGrammarExtractor  {
   ...
   * <br>
   * java -mx4g edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser  -PCFG -saveToSerializedFile englishSplit.ser.gz -saveToTextFile englishSplit.txt -maxLength 40 -train ../data/wsj/wsjtwentytrees.mrg    -testTreebank ../data/wsj/wsjtwentytrees.mrg   -evals "factDA,tsv" -uwm 0  -hMarkov 0 -vMarkov 0 -simpleBinarizedLabels -noRebinarization -predictSplits -splitTrainingThreads 1 -splitCount 1 -splitRecombineRate 0.5
   * <br>
   * may also need
   * <br>
   *  -smoothTagsThresh 0
   * <br>
   * java -mx8g edu.berkeley.nlp.assignments.parsing.parser.lexparser.LexicalizedParser -evals "factDA,tsv" -PCFG -vMarkov 0 -hMarkov 0 -uwm 0 -saveToSerializedFile wsjS1.ser.gz -maxLength 40 -train /afs/ir/data/linguistic-data/Treebank/3/parsed/mrg/wsj 200-2199 -testTreebank /afs/ir/data/linguistic-data/Treebank/3/parsed/mrg/wsj 2200-2219 -compactGrammar 0 -simpleBinarizedLabels -predictSplits -smoothTagsThresh 0 -splitCount 1 -noRebinarization
   */
