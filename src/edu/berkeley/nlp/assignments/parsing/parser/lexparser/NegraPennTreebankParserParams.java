...
import edu.berkeley.nlp.assignments.parsing.trees.international.negra.NegraHeadFinder;
import edu.berkeley.nlp.assignments.parsing.trees.international.negra.NegraLabel;
import edu.berkeley.nlp.assignments.parsing.trees.international.negra.NegraPennLanguagePack;
import edu.berkeley.nlp.assignments.parsing.trees.international.negra.NegraPennTreeReaderFactory;
 ...
 // override output encoding: make it UTF-8
  ...
  public Lexicon lex(Options op, Index<String> wordIndex, Index<String> tagIndex) {
    if (op.lexOptions.uwModelTrainer == null) {
      op.lexOptions.uwModelTrainer = "edu.berkeley.nlp.assignments.parsing.parser.lexparser.GermanUnknownWordModelTrainer";
    }
