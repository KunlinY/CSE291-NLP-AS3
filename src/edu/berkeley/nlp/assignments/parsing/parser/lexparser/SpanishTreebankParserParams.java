...
import edu.berkeley.nlp.assignments.parsing.trees.international.spanish.SpanishHeadFinder;
import edu.berkeley.nlp.assignments.parsing.trees.international.spanish.SpanishTreeReaderFactory;
import edu.berkeley.nlp.assignments.parsing.trees.international.spanish.SpanishTreebankLanguagePack;
 ...
 * AnCora XML with
 * {@link edu.berkeley.nlp.assignments.parsing.trees.international.spanish.SpanishXMLTreeReader}
 * and preprocessed with
 * {@link edu.berkeley.nlp.assignments.parsing.international.spanish.pipeline.MultiWordPreprocessor}.
 *
 * @author Jon Gauthier
 *
 */
public class SpanishTreebankParserParams extends TregexPoweredTreebankParserParams  {
  ...
  public Lexicon lex(Options op, Index<String> wordIndex, Index<String> tagIndex) {
    ...
    if (op.lexOptions.uwModelTrainer == null)
      op.lexOptions.uwModelTrainer =
        "edu.berkeley.nlp.assignments.parsing.parser.lexparser.SpanishUnknownWordModelTrainer";
   ...
   * <p/>
   * Generic options are processed separately by {@link edu.berkeley.nlp.assignments.parsing.parser.lexparser.Options#setOption(String[], int)}, and implementations of this
