...
import edu.berkeley.nlp.assignments.parsing.util.CollectionUtils;
...
import edu.berkeley.nlp.assignments.parsing.util.StringParsingTask;
...
public class SemanticGraph implements Serializable  {
  ...
  /**
   * Returns the <em>first</em> {@link edu.berkeley.nlp.assignments.parsing.ling.IndexedWord
  ...
  /**
   * Returns the <i>first</i> {@link edu.berkeley.nlp.assignments.parsing.ling.IndexedWord
  ...
  /**
   * Returns all nodes of type {@link edu.berkeley.nlp.assignments.parsing.ling.IndexedWord
   * IndexedWord} in this {@code SemanticGraph} having the given word or
