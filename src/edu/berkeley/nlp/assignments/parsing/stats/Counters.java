...
public class Counters  {
  ...
  /**
   * Returns a {@link edu.berkeley.nlp.assignments.parsing.util.PriorityQueue} whose elements are
  ...
  public static <E> edu.berkeley.nlp.assignments.parsing.util.PriorityQueue<E> toPriorityQueue(Counter<E> c) {
    edu.berkeley.nlp.assignments.parsing.util.PriorityQueue<E> queue = new BinaryHeapPriorityQueue<>();
    for (E key : c.keySet()) {
      double count = c.getCount(key);
      queue.add(key, count);
    }
