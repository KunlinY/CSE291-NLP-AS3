 ...
 * {@link edu.berkeley.nlp.assignments.parsing.pipeline.TokensRegexAnnotator},
 * the {@link edu.berkeley.nlp.assignments.parsing.pipeline.TokensRegexNERAnnotator},
 * and the SUTime functionality in {@link edu.berkeley.nlp.assignments.parsing.pipeline.NERCombinerAnnotator}.
 *
 ...
 * <p>{@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.CoreMapExpressionExtractor} and
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.SequenceMatchRules} describes
 ...
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.TokenSequenceMatcher} and
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.TokenSequencePattern} classes which
 ...
 * }</pre>
 * <p>The classes {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.SequenceMatcher} and
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.SequencePattern} can be used to build
 ...
 * <p>
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.MultiPatternMatcher} provides utility functions for
 * finding expressions with multiple patterns.
 * For instance, using {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.MultiPatternMatcher#findNonOverlapping}
 ...
 * you can also use
 * {@link edu.berkeley.nlp.assignments.parsing.ling.tokensregex.MultiWordStringMatcher#findTargetStringOffsets}.
 * </p>
 *
