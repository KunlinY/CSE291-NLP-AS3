...
public class AnnotationLookup {
  ...
  private enum KeyLookup {
    ...
    //HEAD_WORD_KEY("edu.berkeley.nlp.assignments.parsing.ling.TreeCoreAnnotations.HeadWordAnnotation", "hw"),
    //HEAD_TAG_KEY("edu.berkeley.nlp.assignments.parsing.ling.TreeCoreAnnotations.HeadTagAnnotation", "ht"),
