...
import edu.berkeley.nlp.assignments.parsing.ie.util.RelationTriple;
...
public class CoreAnnotations {
   ...
   * tree. See {@link edu.berkeley.nlp.assignments.parsing.trees.Tree#indexSpans(int)}.
   ...
   * tree.  See {@link edu.berkeley.nlp.assignments.parsing.trees.Tree#indexSpans(int)}. This annotation
   ...
   * {@link edu.berkeley.nlp.assignments.parsing.process.WordShapeClassifier} for functions for
   ...
   *
   * @see edu.berkeley.nlp.assignments.parsing.pipeline.KBPAnnotator
   */
   ...
   *
   * @see edu.berkeley.nlp.assignments.parsing.pipeline.WikidictAnnotator
   */
   ...
   * {@link edu.berkeley.nlp.assignments.parsing.naturalli.QuestionToStatementTranslator}.
   *
